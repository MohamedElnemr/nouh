<html><head>
  ...
  <body dir="rtl" class="bg-white g-sidenav-show g-sidenav-pinned" cz-shortcut-listen="true" style="min-height: 100vh;">
      ...
      <div class="container-fluid mt--6 bg-gradient-dark">
                      ...
                      <div class="card-header" style="min-height: 130px;border-radius: 15px;">
                        <div class="box-row">
                            ...
                            <div class="box active">
                                ...
                                <h2 class="text-center mb-0 step-title">الخطوة الاولى</h2>
                                <span class="box-label step-label">البيانات الشخصية</span>
                            </div>
                            ...
                            <div class="box active">
                                ...
                                <h2 class="text-center mb-0 step-title">الخطوة الثانية</h2>
                                <span class="box-label step-label">بيانات الوحدة</span>
                            </div>
                            ...
                            <div class="box active">
                                ...
                                <h2 class="text-center mb-0 step-title">الخطوة الثالثة</h2>
                                <span class="box-label step-label">التكلفة التقديرية</span>
                            </div>

                        </div>
                      </div>

                      <div class="card-body mt-3 text-center" id="card-body" style=""><button onclick="printContent('print');" class="btn btn-sm btn-warning my-3 print-desktop"><i class="fas fa-print"></i> طباعة المستند</button>

          <button onclick="print2();" class="btn btn-sm btn-warning my-3 print-mobile"><i class="fas fa-print"></i> طباعة المستند</button>
          ...
          <div class="w-100 result" id="print">
              <div class="result-frame" style="position: relative;border: 5px solid #c82121;border-radius: 10px;padding: 10px;" dir="rtl">
                  <img src="{{ URL('images/form-17 - copy (3).png ') }}" style="width: 320px;position: absolute;left: 15px;" class="img-lg">
                  ...
                  <div class="col-md-10 m-auto">
                      <div class="row text-right p-2">
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-user"></i>

                                  <input style="color: #32325d"  name="name" value="{{$parameters['name']}}" readonly>
                              </h6>
                          </div>
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-phone"></i>
                                  <input style="color: #32325d"  name="name" value="{{$parameters['phone']}}" readonly>
                              </h6>
                          </div>
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-building"></i> نوع الوحدة: <input style="color: #32325d"  name="name" value="{{$parameters['unit_type']}}" readonly>
                              </h6>
                          </div>
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-map-marker-alt"></i> موقع الوحدة: <input style="color: #32325d"  name="name" value="{{$parameters['location']}}" readonly>
                              </h6>
                          </div>
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-square"></i> أسم الكومبوند : <input style="color: #32325d"  name="name" value="{{$parameters['compound_name']}}" readonly>
                              </h6>
                          </div>
                          <div class="col-md-6 mb-4 col-6">
                            <h6 class="result-text">
                                <i class="fas fa-square"></i> مساحة الوحدة: <input style="color: #32325d"  name="name" value="{{$parameters['area']}}" readonly>
                            </h6>
                        </div>
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-bed"></i> عدد الغرف: <input style="color: #32325d"  name="name" value="{{$parameters['room']}}" readonly>
                              </h6>
                          </div>
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-bath"></i> عدد الحمامات: <input style="color: #32325d"  name="name" value="{{$parameters['bathroom']}}" readonly>
                              </h6>
                          </div>
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-sticky-note"></i> ملاحظات: <input style="color: #32325d"  name="name" value="{{$parameters['nots']}}" readonly>
                              </h6>
                          </div>
                          @if ($parameters['semi_finished'] ==0 && $parameters['Semi_finished_alumetal'] ==0)
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-home"></i>  حالة الوحدة  : <input style="color: #32325d"  name="name" value="{{$parameters['red_bricks']}}" readonly>
                          ...
                          <div class="col-md-6 mb-4 col-6">
                            <h6 class="result-text">
                                <i class="fas fa-home"></i>   حالة الوحدة  : <input style="color: #32325d"  name="name" value="{{$parameters['semi_finished']}}" readonly>
                        ...
                        <div class="col-md-6 mb-4 col-6">
                            <h6 class="result-text">
                                <i class="fas fa-home"></i> حالة الوحدة     : <input style="color: #32325d"  name="name" value="{{$parameters['Semi_finished_alumetal']}}" readonly>
                        ...
                        @if ($parameters['rent'] ==0 && $parameters['Sale'] ==0)
                          <div class="col-md-6 mb-4 col-6">
                              <h6 class="result-text">
                                  <i class="fas fa-building"></i>    غرض التشطيب : <input style="color: #32325d"  name="name" value="{{$parameters['Personal']}}" readonly>
                        ...
                        @if ($parameters['Personal']==0 && $parameters['Sale']==0)
                          <div class="col-md-6 mb-4 col-6">
                            <h6 class="result-text">
                                <i class="fas fa-building"></i>  غرض التشطيب : <input style="color: #32325d"  name="name" value="{{$parameters['rent']}}" readonly>
                        ...
                        <div class="col-md-6 mb-4 col-6">
                            <h6 class="result-text">
                                <i class="fas fa-building"></i>  غرض التشطيب : <input style="color: #32325d"  name="name" value="{{$parameters['Sale']}}" readonly>
   ...
   تلقيطة
    ...
    دهان االبواب اسطور يوتن
     ...
     12-  مواسير فريون :- تاسيس مواسير فريون بحد اقصى 10م      .
        ...
        تجليدة خشبيه لمعبرة مدخل المطبخ
         ...
         12- مواسير فريون  :-تاسيس مواسير فريون بحد اقصى 25م      .
                      ...
                      <div class="col-12 text-center">
                          ...
                          <small>ولمزيد من التفاصيل  او حجز موعد للمعاينة برجاء الاتصال على 01157574442  أو زيارة موقعنا www.Farouk.com ويمكنك متابعة صفحاتنا على جميع وسائل التواصل الاجتماعي و فى حالة اظهار صفحة التكلفة التقديرية اعلاه يتم عمل خصم خاص للعميل</small>
                      </div>
                      <div class="col-12 text-center">
                          <hr>
                          <h5>
      ...
      <!-- Argon JS -->
      <script src="http://kayan-design.com/kayan/admin_assets/js/argon.js?v=1.2.0"></script><div class="backdrop d-xl-none" data-action="sidenav-unpin" data-target="undefined"></div>
