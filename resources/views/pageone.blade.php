<html><head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="00aYSFms9cdUSgtxbdO0nqT7mMznX2pJPMfcCEr9">
    <title>Farouk</title>
    <!-- Favicon -->
              ...
              <div class="col-xl-12">
                  ...
                  <div class="card card-defualt">
                      ...
                      <div class="card-body mt-3 text-center" id="card-body">
                           ...
                           {{-- <form action="{{route('pageonestore')}}" method="post" class="step_form1" >

                              <img src="{{ URL('images/logo.png') }}" style="width: 175px">
                            ...
                            <div class="row justify-content-center">
                              <div class="col-md-8">
                                  ...
                                  <div class="wrap-input100 validate-input mb-4">
                                      <input id="name" type="text" class="input100" name="name" placeholder="الاسم" required="">
                                  ...
                                  <div class="wrap-input100 validate-input mb-4">
                                      <input id="phone" type="text" class="input100" name="phone" placeholder="رقم الهاتف" required="">
                                  ...
                                  <div class="wrap-input100 validate-input mb-4">
                                      <input id="email" type="email" class="input100" name="email" placeholder="البريد الالكتروني" required="">
                            ...
                            <div class="card-footer my-4">
                              <div class="form-group mb-0 text-left">
                                  <button type="submit" class="btn btn-success submit"><i class="fas fa-arrow-circle-left"></i>  التالي </button>
                              </div>
                            </div>
                          </form> --}}


                          {{-- <form action="{{route('pageonestore',$id)}}" method="post"> --}}
