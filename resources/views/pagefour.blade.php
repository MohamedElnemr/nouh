      ...
      <div class="container-fluid mt--6 bg-gradient-dark">
          ...
          <div class="col-md-10 m-auto">
              <div class="my-5 d-flex justify-content-between">
                  <h3 class="font-weight-bold">والأن أخبرنا عن الحالة الحالية للوحدة</h3>
                  <h3 class="font-weight-bold">Now tell us about the current state of the unit</h3>
              </div>
                  ...
                  <div class="col-xl-3 col-md-4 col-10">
                      <div class="card card-defualt choose-card">
                          <div class="card-body p-0">
                                ...
                                <button type="submit" >
                              <img class="img-fluid px-0" src="{{ URL('images/form-08.png') }}" alt="" style="border-radius: 60px 60px 5px 5px;">
                      ...
                      <div class="card card-defualt choose-card" >
                          <div class="card-body p-0">
                            <form action="{{route('pagefourstore')}}" method="post">
                                ...
                                <button type="submit" >
                              <img class="img-fluid px-0" src="{{ URL('images/form-07.png') }}" alt="" style="border-radius: 60px 60px 5px 5px;">
                              <div class="text-center">
                                <h4 class="my-4">
                                    نصف تشطيب
                                </h4>
                      ...
                      <div class="card card-defualt choose-card">
                          <div class="card-body p-0">
                            ...
                            <form action="{{route('pagefourstore')}}" method="post">
                                ...
                                <button type="submit" >
                              <img class="img-fluid px-0" src="{{ URL('images/form-06.png') }}" alt="" style="border-radius: 60px 60px 5px 5px;">
                              <div class="text-center">
                                  <h4 class="my-4">
