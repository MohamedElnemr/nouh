          ...
          <div class="row justify-content-center mt-4">
              <div class="col-md-8">
                  ...
                  <div class="my-3 d-flex justify-content-between">
                      <h3>ما هي نوع الوحدة المراد تشطيبها ؟</h3>
                  ...
                  <div class="my-3 d-flex justify-content-between">
                      <h3>هل هذه الوحدة تقع داخل كومبوند سكنى؟</h3>
                  ...
                  <div class="compound-box">
                      ...
                      <div class="wrap-input100 validate-input mb-4">
                          <input id="compound_name" type="text" class="input100" name="compound_name" placeholder="الكومبوند">
