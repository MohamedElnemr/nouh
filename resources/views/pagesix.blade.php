                      ...
                      <div class="card card-defualt choose-card" style="border-radius: 15px;" >
                        ...
                        <form action="{{route('pagesixstore')}}" method="post">
                          ...
                          <div class="card-body p-0">
                              ...
                              <img class="img-fluid px-0" src="{{ URL('images/bronze.jpg') }}" alt="" style="border-radius: 60px 60px 5px 5px;">
                  ...
                  <div class="col-xl-2 col-md-2 col-10">
                      <div class="card card-defualt choose-card" style="border-radius: 15px;" >
                        ...
                        <form action="{{route('pagesixstore')}}" method="post">
                          ...
                          <div class="card-body p-0">
                              <img class="img-fluid px-0" src="{{ URL('images/silver.jpg') }}" alt="" style="border-radius: 60px 60px 5px 5px;">
                              <div class="text-center">
                                  <h4 class="my-2">
                                      الباقة المتوسطة
                                  </h4>
                  ...
                  <div class="col-xl-2 col-md-2 col-10">
                      <div class="card card-defualt choose-card" style="border-radius: 15px;" >
                        ...
                        <form action="{{route('pagesixstore')}}" method="post">
                          ...
                          <div class="card-body p-0">
                              <img class="img-fluid px-0" src="{{ URL('images/gold.jpg') }}" alt="" style="border-radius: 60px 60px 5px 5px;">
                              <div class="text-center">
                                  <h4 class="my-2">
                                  باقة VIP
                                  </h4>
                  ...
                  <div class="col-xl-2 col-md-2 col-10">
                    <div class="card card-defualt choose-card" style="border-radius: 15px;" >
                        ...
                        <form action="{{route('pagesixstore')}}" method="post">
                            ...
                            <input type="hidden" name="Sale" value="{{$parameters['Sale']}}">
                        <div class="card-body p-0">
                            <img class="img-fluid px-0" src="{{ URL('images/gold - copy.jpg') }}" alt="" style="border-radius: 60px 60px 5px 5px;">
                            <div class="text-center">
                                <h4 class="my-2">
                                  ULTRA VIP
                                </h4>
                  ...
                  <div class="col-xl-2 col-md-2 col-10" >
                      <div class="card card-defualt choose-card" style="border-radius: 15px;"  >
                        ...
                        <form action="{{route('pagesixstore')}}" method="post">
                          ...
                          <div class="card-body p-0">
                              <img class="img-fluid px-0" src="{{ URL('images/platinum.jpg') }}"  style="border-radius: 60px 60px 5px 5px;">
                              <div class="text-center">
                                  <h4 class="my-2">
                                       SUPER Ultra VIP
                                  </h4>
