<html><head>
  ...
  <body dir="rtl" class="bg-white g-sidenav-hidden" cz-shortcut-listen="true" style="min-height: 100vh;">
      ...
      {{-- <form class="step_form2" data-step="3">
          <div class="row justify-content-center mt-4">
              <div class="col-md-8">

                  <div class="my-3 d-flex justify-content-between">
                      <h3>المساحة بالمتر</h3>
                      <h3>Area in Meters</h3>
                  </div>
                  <div class="wrap-input100 validate-input mb-4">
                      <input id="area" type="number" min="1" class="input100" name="area" placeholder="المساحة" required="">
                  ...
                  <div class="wrap-input100 validate-input mb-4">
                      <input id="rooms" type="number" min="0" class="input100" name="rooms" placeholder="الغرف" required="">
                  ...
                  <div class="wrap-input100 validate-input mb-4">
                      <input id="bathroom" type="number" min="0" class="input100" name="bathroom" placeholder="الحمام" required="">
                  ...
                  <div class="wrap-input100 validate-input mb-4">
                      <textarea type="text" class="input100" name="notes" placeholder="الملاحظات"></textarea>
          ...
          <input type="hidden" name="unit_type" value="بينت هاوس">
          <input type="hidden" name="location" value="الساحل الشمالى">
          <input type="hidden" name="compound" value="0">
          <input type="hidden" name="compound_name" value="">
      ...
      <form action="{{route('pagethreestore')}}" method="post">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-8">
                ...
                <div class="wrap-input100 validate-input mb-4">
                    <input id="room" type="number" min="0" class="input100" name="room" placeholder="الغرف" required="">
                ...
                <div class="wrap-input100 validate-input mb-4">
                    <textarea type="text" class="input100" name="nots" placeholder="الملاحظات"></textarea>
