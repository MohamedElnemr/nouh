              ...
              <div class="col-xl-12">
                  ...
                  <div class="col-md-10 m-auto">
                      <div class="my-5 d-flex justify-content-between">
                          <h3 class="font-weight-bold">ما هو الغرض من التشطيب</h3>
                          <h3 class="font-weight-bold">What is the purpose of finishing</h3>
                      </div>
                          ...
                          <div class="col-xl-3 col-md-4 col-10">
                              <div class="card card-defualt choose-card" >
                                  <div class="card-body px-3">
                                    ...
                                    <button type="submit" >
                                      <img class="img-fluid px-4" style="width: 500px" src="{{ URL('images/form-11.png') }}" alt="">
                              ...
                              <div class="card card-defualt choose-card">
                                  <div class="card-body px-3">
                                    <form action="{{route('pagefivestore')}}" method="post">
                                        ...
                                        <input type="hidden" name="Semi_finished_alumetal" value="{{$parameters['Semi_finished_alumetal']}}">
                                    <button type="submit" >
                                      <img class="img-fluid px-4" style="width: 500px" src="{{ URL('images/form-10.png') }}" alt="" style="width: 130px;">
                                      <div class="text-center">
                                          <h4 class="mt-2">
                                              بغرض الايجار
                                          </h4>
                              ...
                              <div class="card card-defualt choose-card" >
                                  <div class="card-body px-3">
                                    ...
                                    <form action="{{route('pagefivestore')}}" method="post">
                                        ...
                                        <input type="hidden" name="Semi_finished_alumetal" value="{{$parameters['Semi_finished_alumetal']}}">
                                    <button type="submit" >
                                      <img class="img-fluid px-4" style="width: 500px" src="{{ URL('images/form-09.png') }}" alt="" style="width: 160px;">
                                      <div class="text-center">
                                          <h4 class="mt-2">
                                              اعادة البيع
                                          </h4>
